 ...
 */
public class CustomerDaoInterfacePlugin extends PluginAdapter {

    private static final String DEFAULT_DAO_SUPER_CLASS = ".MySqlBaseMapper";
    private static  final String baseDaoTargetPackage = "com.winston.base";
    ...
    public CustomerDaoInterfacePlugin() {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        Interface mapperInterface = new Interface(baseDaoTargetPackage + DEFAULT_DAO_SUPER_CLASS);

        if (stringHasValue(baseDaoTargetPackage)) {
            ...
            mapperInterface.addJavaDocLine(" * " + "@param <M>  这里是泛型指的是某个Model类");
            ...
            try {
                File mapperDir = shellCallback.getDirectory(daoTargetDir, baseDaoTargetPackage);
                String fileName = mapperJavafile.getFileName();
    ...
    public boolean clientGenerated(Interface interfaze,
        ...
        String daoSuperClass = baseDaoTargetPackage + DEFAULT_DAO_SUPER_CLASS;
